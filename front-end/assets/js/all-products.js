(function () {
  ...
  var PRODUCTS = [
    {
      id: 1,
      name: "YAG Iridectomy Lens",
      price: 1800,
      brand: "acmed",
      category: "ophthalmology",
      procedures: ["glaucoma", "anterior-segment"],
      inStock: true,
      date: Date.now() - 1000000,
    },
    {
      id: 2,
      name: "Fundus Lens 78D",
      price: 2200,
      brand: "zeiss",
      category: "ophthalmology",
      procedures: ["general"],
    ...
    {
      id: 3,
      name: "Goldmann 3-Mirror Lens",
      price: 3500,
      brand: "zeiss",
      category: "ophthalmology",
      procedures: ["glaucoma", "cornea"],
      inStock: true,
      date: Date.now() - 3000000,
    },
    {
      id: 4,
      name: "Capsulorhexis Forceps 0.12mm",
      price: 1700,
      brand: "acmed",
      category: "surgical-instruments",
      procedures: ["capsulotomies", "cataract"],
      inStock: true,
      date: Date.now() - 4000000,
    },
    {
      id: 5,
      name: "Tissue Forceps Angled",
      price: 1650,
      brand: "madhu",
      category: "surgical-instruments",
      procedures: ["cornea", "anterior-segment"],
      inStock: true,
    ...
    },
    {
      ...
      brand: "zeiss",
      category: "diagnostic-instruments",
      procedures: ["anterior-segment", "cornea"],
      inStock: false,
    ...
    {
      id: 11,
      name: "Colposcope Digital",
      price: 22000,
      brand: "zeiss",
      category: "gynecology",
      procedures: ["general"],
      inStock: true,
      date: Date.now() - 11000000,
    },
    {
      id: 12,
      name: "Uterine Dilator Set",
      price: 1800,
      brand: "acmed",
      category: "gynecology",
      procedures: ["general"],
    ...
    {
      id: 13,
      name: "Phaco Tip Kelman Angled",
      price: 1600,
      brand: "moria",
      category: "ophthalmology",
      procedures: ["phaco", "cataract"],
      inStock: true,
      date: Date.now() - 13000000,
    },
    {
      id: 14,
      name: "Lacrimal Dilator Probe",
      price: 720,
      brand: "katena",
      category: "ophthalmology",
      procedures: ["lacrimal", "dacryocystorhinostomy"],
      inStock: true,
      date: Date.now() - 14000000,
    },
    {
      id: 15,
      name: "LASIK Microkeratome Blade",
      price: 2800,
      brand: "moria",
      category: "ophthalmology",
      procedures: ["lasik", "refractive"],
      inStock: false,
      date: Date.now() - 15000000,
    },
    {
      id: 16,
      name: "Chalazion Clamp",
      price: 590,
      brand: "acmed",
      category: "ophthalmology",
      procedures: ["chalazion", "eyelid"],
      inStock: true,
      date: Date.now() - 16000000,
    },
    {
      id: 17,
      name: "Retinal Camera",
    ...
    },
    {
      ...
      procedures: ["cornea", "anterior-segment"],
      inStock: true,
      date: Date.now() - 19000000,
    },
    {
      id: 20,
      name: "Strabismus Hook Fine",
      price: 1200,
      brand: "katena",
      category: "surgical-instruments",
      procedures: ["pediatric", "general"],
      inStock: true,
  ...
  function productCardHtml(p) {
    ...
    var outOfStock = p.inStock
      ? ""
      : '<span class="ap-out-of-stock-badge">Out of stock</span>';
    var dataAttrs =
      ' data-product-id="' +
      p.id +
      '"' +
    ...
    var addBtn = p.inStock
      ...
      : '<a href="#" class="btn-add-cart btn-add-cart--disabled"' +
        dataAttrs +
        ' onclick="event.stopPropagation()">Out of stock</a>';
    ...
    return (
      ...
      p.name +
      '" loading="lazy" />' +
      '<span class="fp-card-company-badge">' +
      brand +
      "</span>" +
      outOfStock +
      "</div>" +
  ...
  function renderPagination(total) {
    ...
    for (var i = 1; i <= totalPages; i += 1) {
      html +=
        '<button class="ap-page-btn' +
        (i === state.page ? " ap-page-btn--active" : "") +
        '" data-page="' +
        i +
        '">' +
        i +
  ...
  function renderGrid() {
    ...
    if (!pageItems.length) {
      grid.innerHTML =
        '<p class="fp-no-results">No products match your filters. <a href="#" id="apClearFilters">Clear filters</a></p>';
  ...
  function bindEvents() {
    document.querySelectorAll(".ap-radio").forEach(function (radio) {
      radio.addEventListener("change", function () {
        ...
        state.page = 1;
        document
          .querySelectorAll("#apCategoryList .ap-filter-item")
